...
@section('content')
                        ...
                        <div class="card card-details mb-3">
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    <a href="{{ route('checkout-remove', $detail->id) }}">
                                                        <img src="{{ url('nomads-template/frontend/images/ic_remove.png') }}"
                                                            alt="" />
                                                    </a>
                                                </td>
                                            </tr>
                            ...
                            <div class="member mt-3">
                                ...
                                <form class="form-inline" method="POST"
                                    ...
                                    <select class="custom-select mb-2 mr-sm-2" name="is_visa" id="inputVisa">
                        ...
                        <div class="card card-details card-right">
                            ...
                            <div class="bank">
                                <div class="bank-item pb-3">
                                    <img src="{{ url('nomads-template/frontend/images/logo_bank.png') }}" alt=""
                                        class="bank-image" />
    ...
    @push('prepend-style')
        ...
        <link rel="stylesheet" href="{{ url('nomads-template/frontend/libraries/gijgo/css/gijgo.min.css') }}">

    @endpush

    @push('addon-script')

        <script src="{{ url('nomads-template/frontend/libraries/gijgo/js/gijgo.min.js') }}"></script>
        <script>
            $(document).ready(function() {
                ...
                $('.datepicker').datepicker({
                    ...
                    icons: {
                        rightIcon: '<img src="{{ url('nomads-template/frontend/images/ic_doe.png') }}" alt="" />'
                    }
                });
