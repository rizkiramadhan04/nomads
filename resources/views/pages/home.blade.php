      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-8 text-center">
            <img src="nomads-template/frontend/images/logos_partner.png" class="img-patner" />
          </div>
        </div>
      </div>
    </section>
        ...
        >
          <div class="col-sm-6 col-md-6 col-lg-4">
            <div class="card card-testimonial text-center">
              <div class="testimonial-content">
                <img
                  src="nomads-template/frontend/images/avatar-1.png"
                  alt=""
          ...
          <div class="col-sm-6 col-md-6 col-lg-4">
            <div class="card card-testimonial text-center">
              <div class="testimonial-content">
                <img
                  src="nomads-template/frontend/images/avatar-2.png"
                  alt=""
                  class="mb-4 rounded-circle"
                />
          ...
          <div class="col-sm-6 col-md-6 col-lg-4">
            <div class="card card-testimonial text-center">
              <div class="testimonial-content mb-auto">
                <img
                  src="nomads-template/frontend/images/avatar-3.png"
                  alt=""
                  class="mb-4 rounded-circle"
                />
